...
8. **NEVER use em-dashes (—).** Em-dashes are an AI tell. Use periods, commas, or colons instead. Also avoid: "It's worth noting", "Importantly", "Delve into", "Robust", "Leverage" as verb. Plain, direct English. Short sentences.
